...
filename = '../../../data/raw/phase1_movie_reviews-train.csv'
fileout = 'phase1_movie_reviews-train_spell'
...
if split:
    ...
    validate.to_csv('../../../data/processed/tok_'+fileout+'_validate'+str(int(round((1-split_train)*100/2, 0)))+'.csv', index=False)
    test.to_csv('../../../data/processed/tok_'+fileout+'_test'+str(int(round((1-split_train)*100/2, 0)))+'.csv', index=False)
else:
    df.to_csv('../../../data/processed/tok_'+fileout+'.csv', index=False)

print("done with movie_reviews_train")
